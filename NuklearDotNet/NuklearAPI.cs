...
namespace NuklearDotNet {
	...
	public static unsafe class NuklearAPI {
		...
		public static bool Window(string Name, string Title, float X, float Y, float W, float H, NkPanelFlags Flags)
		{
			bool Res = true;
		...
		public static bool Window(string Title, float X, float Y, float W, float H, NkPanelFlags Flags) => Window(Title, Title, X, Y, W, H, Flags);
