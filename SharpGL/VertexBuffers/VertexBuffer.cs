...
namespace SharpGL.VertexBuffers
{
    ...
    public class VertexBuffer
    {
        ...
        public void SetDataV2F(OpenGL gl, uint attributeIndex, IntPtr data, int size, bool isNormalised, int stride)
        {
            gl.BufferData(OpenGL.GL_ARRAY_BUFFER, size, data, OpenGL.GL_STATIC_DRAW);
            gl.VertexAttribPointer(attributeIndex, 3, OpenGL.GL_FLOAT, isNormalised, stride, IntPtr.Zero);
            gl.EnableVertexAttribArray(attributeIndex);
        }
